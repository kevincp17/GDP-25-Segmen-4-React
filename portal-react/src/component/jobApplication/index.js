...
function JobApplication() {
    ...
    data.map(apply => {
        dataApplyRow.push({
            ...
            action: <><Button variant="primary" onClick={() => handleSetInterview(apply.status.status_id, apply.career.job_id, apply.career.title, apply.applicant.cv.cv_id, apply.applicant.cv.name)}><AiOutlineLink /></Button> <Button variant="success"><AiOutlineCheck onClick={() => handleAccept(apply.apply_id, apply.status.status_id)} /></Button> <Button variant="danger" onClick={() => handleReject(apply.apply_id)}><AiOutlineClose /></Button></>
        })
    })
